...
func TestEveryFieldChangesTheDigest(t *testing.T) {
	...
	mutations := map[string]func(*Delegation){
		...
		"event class":      func(d *Delegation) { d.AllowedEventClasses = []string{"approval", "text"} },
...
func TestValidateRejectsBoundaryViolations(t *testing.T) {
	cases := map[string]func(*Delegation){
		...
		"no classes":            func(d *Delegation) { d.AllowedEventClasses = nil },
		"unsorted classes":      func(d *Delegation) { d.AllowedEventClasses = []string{"text", "agent.task"} },
		"duplicate classes":     func(d *Delegation) { d.AllowedEventClasses = []string{"text", "text"} },
		"bad class":             func(d *Delegation) { d.AllowedEventClasses = []string{"Text"} },
		"empty class":           func(d *Delegation) { d.AllowedEventClasses = []string{""} },
		"too many classes":      func(d *Delegation) { d.AllowedEventClasses = manyClasses(MaxEventClasses + 1) },
