...
func openJournalAt(root string, quota Quota) (*Journal, error) {
	...
	for _, name := range []string{inboundDir, outboundDir, sessionDir, approvalDir, mandateDir, budgetDir, mandateBudgetDir, negotiationDir, deviceDir, roomDir, mlsDir, executionDir} {
