...
| `pkg/attachments`, `pkg/attachmentapi`, `cmd/tos-attachmentd` | Route-neutral AES-256-GCM private chunks, secret E2EE references, ordered ciphertext manifests, finalized Endpoint-scoped upload/fetch/delete capabilities, restart-safe nonce claims, bounded resumable opaque storage, signed storage ACKs, and strict public-HTTPS locator/SSRF policy |
